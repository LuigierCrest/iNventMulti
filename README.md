...
- Funcionalidades de inventario para centros escolares, incluyendo gestión de dispositivos y sus incidencias.
- Tres roles de usuario: Administrador, Directivo y responsable.
- Sincronización de datos entre plataformas utilizando una API REST con actualización de datos en tiempo real.
### Licencia
